################################################################################
##
## Image Attributes Tool by Feniks (feniksdev.itch.io / feniksdev.com)
##
################################################################################
...
style attr_vp_viewport:
    xsize int(config.screen_width/2.2)-30
style attr_vp_hbox:
    xmaximum int(config.screen_width/2.2)-60 box_wrap True
    spacing 10 box_wrap_spacing 10
